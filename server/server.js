...
app.use(helmet({
    contentSecurityPolicy: {
        ...
        directives: {
            "default-src": ["'self'"],
            "connect-src": ["'self'", "https://api.dicebear.com", "http://localhost:5000", "https://*.render.com", "https://*.googleapis.com", "https://*.firebaseio.com", "wss://*.firebaseio.com", "https://*.googlesyndication.com", "https://*.doubleclick.net", "https://*.google.com", "https://*.googleadservices.com", "https://firestore.googleapis.com", "https://ep1.adtrafficquality.google"],
            "img-src": ["'self'", "data:", "blob:", "https://api.dicebear.com", "https://*.googleusercontent.com", "https://www.svgrepo.com", "https://www.transparenttextures.com", "https://images.unsplash.com", "https://*.r2.cloudflarestorage.com", "https://media.giphy.com", "https://*.googlesyndication.com", "https://*.doubleclick.net", "https://*.google.com", "https://*.gstatic.com", "https://*.googleadservices.com"],
            ...
            "script-src-elem": ["'self'", "'unsafe-inline'", "blob:", "https://*.google.com", "https://*.gstatic.com", "https://*.googlesyndication.com", "https://*.googleadservices.com", "https://*.doubleclick.net"],
