                    ...
                    >
                        ...
                        <div className="flex justify-between items-start mb-6 shrink-0">
                            <div className="space-y-1">
                                <h3 className="text-3xl font-black text-white italic tracking-tighter uppercase">Reward_Vault</h3>
                        ...
                        <div className="mb-6 bg-void/50 border border-white/5 rounded-2xl p-4 flex items-center justify-between shrink-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-black text-white">{(currentUser.stats?.withdrawableKpc || 0).toLocaleString()} <span className="text-xs text-gray-400">KPC</span></p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleRedeem} className="mt-auto pt-6 border-t border-white/5 space-y-4 shrink-0">
